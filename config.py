...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7647944594:AAHqs3RpZWulrxwDcVpaymhmVoW80FgecY0")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002672142627"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7040944963"))

#Port
PORT = os.environ.get("PORT", "3313")
